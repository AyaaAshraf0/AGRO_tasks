...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from service_define.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from service_define.srv._add_two_ints import AddTwoInts_Request as Request
    from service_define.srv._add_two_ints import AddTwoInts_Response as Response
