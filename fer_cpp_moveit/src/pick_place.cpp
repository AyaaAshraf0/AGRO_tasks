 ...
 */
 ...
 int main(int argc, char * argv[])
 {
   ...
   arm_group_interface.setPlannerId("RRT");  
   ...
   auto const arm_target_pose = [&node]{
     ...
     msg.pose.position.x = 0.476;
     msg.pose.position.y = 0.512;
     msg.pose.position.z = 0.525;
     msg.pose.orientation.x = 0.715;
     msg.pose.orientation.y = -0.336;
     msg.pose.orientation.z = 0.554;
     msg.pose.orientation.w = -0.260;
     return msg;
   }();
